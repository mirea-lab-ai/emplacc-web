...
export function SkeletonWidget({ rows = 3 }: { rows?: number }) {
  return (
    <div className="t-surface rounded-2xl p-5 space-y-4 ring-1 ring-app h-full">
...
export function SkeletonProjectRow() {
  return (
    <div className="flex items-center gap-4 px-4 py-4 border-b border-app last:border-0">
      <div className="flex-1 space-y-2">
...
export function SkeletonTaskItem() {
  return (
    <div className="rounded-xl bg-app-subtle ring-1 ring-app p-3 space-y-2">
...
export function SkeletonKanbanCard() {
  return (
    <div className="rounded-xl bg-app-subtle ring-1 ring-app p-3 space-y-2.5">
